...
author: '[Simon Keith](https://fr.linkedin.com/in/simonkth), [Actinvision](http://www.actinvision.fr/)'
date: "7 avril 2016"
output:
  html_document:
    highlight: zenburn
...
str(insertion)
```
_Dernière date de téléchargement du jeu de données : `r file.mtime("./data/insertion_raw.csv")`._  
<br>  
